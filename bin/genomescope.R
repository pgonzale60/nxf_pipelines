...
report_results<-function(kmer_hist,kmer_hist_orig, k, container, foldername)
{
    ...
    cat(paste(sprintf(format_column_1,"Heterozygosity"),        sprintf(format_column_2,percentage_format(het[2])), sprintf(format_column_3,percentage_format(het[1])), sep=""),                                file=summaryFile, sep="\n", append=TRUE)
